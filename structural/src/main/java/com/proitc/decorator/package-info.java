/**
 * Definition: This main principle of this pattern says that we cannot modify existing
 * functionalities but we can extend them. In other words, this pattern is open for extension but
